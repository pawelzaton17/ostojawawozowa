                                ...
                                <div class="single-post-preview__arrows acf-block-calendar__arrows w-100 position-md-absolute">
                                    <div class="crunch-tiny-slider__controls d-flex align-items-center h-100 js-crunch-tiny-slider-custom-controls acf-block-calendar__mobile-controls w-100 c-px-6 c-px-md-0">
                                        <div class="acf-block-calendar__slider-buttons">
                                            <div class="acf-block-calendar__slider-button-item d-md-none border-0 line-height-1-2 crunch-button acf-block-calendar__slider-button crunch-button--file crunch-button__full-background crunch-button__full-background--primary-color text-decoration-none font-family-primary w-100 font-size-14">
                                                Wcześniejszy termin
                                            </div>
                                        ...
                                        <div class="acf-block-calendar__slider-buttons">
                                            <div class="acf-block-calendar__slider-button-item d-md-none border-0 line-height-1-2 crunch-button crunch-button--file acf-block-calendar__slider-button crunch-button__full-background crunch-button__full-background--primary-color text-decoration-none font-family-primary w-100 font-size-14">
                                                Pózniejszy termin
                                            </div>
