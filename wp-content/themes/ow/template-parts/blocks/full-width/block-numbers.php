    ...
    <div class="container">
        ...
        <?php if ( have_rows( 'v_items' ) ): ?>
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-8">
                        <h2 class="acf-block-numbers__left-heading c-pb-4 c-pb-md-3 position-relative font-weight-bold font-size-36">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-12">
                        <h2 class="acf-block-numbers__right-heading c-pb-4 c-pb-md-3 position-relative font-weight-bold font-size-36">
